...
import numpy as np
simul_name = "Predictive Learn and Apply toy-case"
AOtype="mcao" 
...
p_tel.set_diam(8.0)
p_tel.set_cobs(0.0) # need to fix projector before changing this I think

###################
# ATMOS
p_atmos = conf.Param_atmos()
p_atmos.set_r0(0.1182) # 0.1289 * cos(30)^0.6
p_atmos.set_nscreens(4)
p_atmos.set_frac([0.5, 0.2, 0.2, 0.1])
p_atmos.set_alt([30, 4500, 9200, 14000])
p_atmos.set_windspeed([10, 15, 20, 15])
p_atmos.set_winddir([0., 30., 111., 260])
...
p_dm0.set_nact(41)
p_dm0.set_alt(0.)
p_dm0.set_thresh(0.2) #<- 0.1
p_dm0.set_coupling(0.3)
p_dm0.set_unitpervolt(1)
p_dm0.set_push4imat(1)

p_dm1.set_type("pzt")
p_dm1.set_nact(41)    # TODO try increasing this to ~49 now that everything else is good
p_dm1.set_alt(6000.)
...
p_dm2.set_type("pzt")
p_dm2.set_nact(41)   # TODO try increasing this to ~49 now that everything else is good
p_dm2.set_alt(13500.)
