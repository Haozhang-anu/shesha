...
'''
p_atmos.set_nscreens(8)
p_atmos.set_frac([0.59, 0.02, 0.04, 0.06, 0.01, 0.05, 0.09, 0.14])#,  0.05,  0.05])
...
p_atmos.set_frac([0.59, 0.12, 0.14, 0.15])#, 0.01, 0.05, 0.09, 0.14])#,  0.05,  0.05])
p_atmos.set_alt([30,  140,  281,  562])#, 1125, 2250, 4500, 7750])#, 11000, 14000])
p_atmos.set_windspeed([ 6.6,  5.9,  5.1,  4.5])#,  5.1,  8.3, 16.3, 30.2])#,  34.3,  17.5])
p_atmos.set_winddir([0.,  10.,  20.,  25.])#,   0.,  10.,  20.,  25.])#,    0.,   10.])
p_atmos.set_L0([25., 25., 25., 25.])#, 25., 25., 25., 25.])#, 25., 25.])
...
p_dm1.set_type("pzt")
p_dm1.set_nact(49)    # TODO try increasing this to ~49 now that everything else is good
p_dm1.set_alt(6000.)
p_dm1.set_thresh(0.)
...
p_dm2.set_type("pzt")
p_dm2.set_nact(49)   # TODO try increasing this to ~49 now that everything else is good
p_dm2.set_alt(13500.)
p_dm2.set_thresh(0.)
