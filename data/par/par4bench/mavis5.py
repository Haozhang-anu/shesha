...
p_atmos.set_windspeed(list(np.array([ 6.6,  5.9,  5.1,  4.5,  5.1,  8.3, 16.3, 30.2,  34.3,  17.5])*1000))
p_atmos.set_winddir(list(np.array([0.,  10.,  20.,  25.,   0.,  10.,  20.,  25.,    0.,   10.])+180.))
...
ts_xpos = np.append(np.append(0.25*lgs_xpos,0.5*lgs_xpos),lgs_xpos)
ts_ypos = np.append(np.append(0.25*lgs_ypos,0.5*lgs_ypos),lgs_ypos)
